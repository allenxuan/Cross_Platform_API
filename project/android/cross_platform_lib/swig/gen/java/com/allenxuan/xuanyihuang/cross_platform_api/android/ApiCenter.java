...
public class ApiCenter {
  ...
  public void setDataSharedPtrUnorderedMap(DataSharePtrUnorderedMap a_data_shared_ptr_unordered_map) {
    CrossPlatformApiJNI.ApiCenter_setDataSharedPtrUnorderedMap(swigCPtr, this, DataSharePtrUnorderedMap.getCPtr(a_data_shared_ptr_unordered_map), a_data_shared_ptr_unordered_map);
  }

  public DataSharePtrUnorderedMap getDataSharedPtrUnorderedMap() {
    return new DataSharePtrUnorderedMap(CrossPlatformApiJNI.ApiCenter_getDataSharedPtrUnorderedMap(swigCPtr, this), true);
  }
